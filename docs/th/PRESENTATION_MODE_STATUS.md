...
> - [x] แยกแผงการตั้งค่า Typing และ Presentation ออกจากกัน เพิ่มการจำค่ารายโหมด และเสริมตัวเลือกการเล่นอัตโนมัติสำหรับโหมดนำเสนอ (ความเร็ว, ระยะเวลาต่อสไลด์, โหมด loop/bounce/once) เพื่อเตรียมต่อยอดฟีเจอร์ระยะถัดไป
